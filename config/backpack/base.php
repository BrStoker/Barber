...
//        'packages/backpack/base/css/bundle.css', // has primary color electric purple (backpack default)
    ...
    'project_logo'   => '<b>Bar</b>ber',

    // Show / hide breadcrumbs on admin panel pages.
    'breadcrumbs' => false,

    // Horizontal navbar classes. Helps make the admin panel look similar to your project's design.
    'header_class' => 'app-header bg-secondary border-0 navbar navbar-dark',
    ...
    'sidebar_class' => 'sidebar sidebar-dark bg-secondary sidebar-dark',
    ...
    'developer_name' => 'Youriy K',

    // Developer website. Link in footer. Type false if you want to hide it.
    'developer_link' => 'https://github.com/BrStoker',
